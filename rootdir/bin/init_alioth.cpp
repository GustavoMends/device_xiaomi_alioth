...
void load_redmi_k40() {
    ...
    property_override("ro.build.fingerprint", "Redmi/alioth/alioth:12/RKQ1.211001.001/V13.0.7.0.SKHCNXM:user/release-keys");
    property_override("ro.build.description", "alioth-user 12 RKQ1.211001.001 V13.0.7.0.SKHCNXM release-keys");
}
...
void load_poco_f3() {
    ...
    property_override("ro.build.fingerprint", "Redmi/alioth_global/alioth:12/RKQ1.211001.001/V13.0.5.0.SKHMIXM:user/release-keys");
    property_override("ro.build.description", "alioth_global-user 12 RKQ1.211001.001 V13.0.5.0.SKHMIXM release-keys");
}
...
void load_xiaomi_mi11x() {
    ...
    property_override("ro.build.fingerprint", "Redmi/aliothin/alioth:12/RKQ1.211001.001/V13.0.7.0.SKHINXM:user/release-keys");
    property_override("ro.build.description", "aliothin-user 12 RKQ1.211001.001 V13.0.7.0.SKHINXM release-keys");
}
