...
void load_poco_f3() {
    ...
    property_override("ro.build.fingerprint", "Redmi/alioth_global/alioth:12/RKQ1.200826.002/V13.0.3.0.SKHMIXM:user/release-keys");
    property_override("ro.build.description", "alioth_global-user 12 RKQ1.200826.002 V13.0.3.0.SKHMIXM release-keys");
}
